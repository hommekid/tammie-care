...
- `theme.css` และ `lib.js` ติด `?v=NN` cache-bust แล้ว — **แก้ CSS/lib ต้อง bump เลข `?v=` ทุกไฟล์** · **เลขปัจจุบัน = 26** (`sed -i '' 's/theme.css?v=26/theme.css?v=27/g; s/lib.js?v=26/lib.js?v=27/g' app/*.html`)
