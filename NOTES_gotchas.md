...
- `theme.css` และ `lib.js` ติด `?v=NN` cache-bust แล้ว — **แก้ CSS/lib ต้อง bump เลข `?v=` ทุกไฟล์** · **เลขปัจจุบัน = 36** (`sed -i '' 's/theme.css?v=36/theme.css?v=37/g; s/lib.js?v=36/lib.js?v=37/g' app/*.html`)
