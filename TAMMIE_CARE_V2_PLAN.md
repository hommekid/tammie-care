...
| · ปรับปรุงผลเลือด | ✅ เสร็จ 19 ก.ค. 2026 | จัดการค่าตรวจ + เกณฑ์ปกติต่อหมวด (ตั้งตอนเพิ่มหมวด/แก้ทีหลัง) · แก้ชื่อหมวด + ลบทั้งหมวด · รองรับค่า `< >` ที่เครื่องนับไม่ได้ (เช่น `>2000`) คิดเกณฑ์อันตรายจากเครื่องหมาย · จิ้มการ์ดค่าเพื่อดูกราฟแนวโน้ม (แทน dropdown) |
...
- **แก้โปรไฟล์/การ์ด** — ชื่อเล่น/พันธุ์/วันเกิด/รูปโปรไฟล์/สถานะการ์ด (เฝ้าระวัง/ปกติ/ต้องดูแล) ยังแก้ผ่านเว็บไม่ได้ (ชิ้นเล็ก)
- **Step 7 cutover**
