...
> 📄 **แผนฉบับเต็มอยู่ที่ไฟล์แยก: [`JOIN_FLOW_PLAN.md`](JOIN_FLOW_PLAN.md)** — เขียนใหม่ทั้งฉบับ (v2) 2 ก.ย. 2026
> — **Phase A** รื้อสิทธิ์ให้เป็นราย-ครอบครัว (1 บัญชีอยู่ได้หลายบ้าน) + `create_family` / `leave_family`
> — **Phase B** `join_requests` + รหัสครอบครัว 6 หลัก (unique) + สวิตช์ public/private · RLS · RPC 10 ตัว · UI 5 ไฟล์
> ⚠️ ข้อสรุปเดิม "1 บัญชี = 1 ครอบครัว" **ยกเลิกแล้ว** · ข้างล่างนี้คือบันทึกตั้งต้นเดิม เก็บไว้เป็นที่มา
