...
**เหลือก่อนปิด Phase 1:**
- **หน้าจัดการครอบครัว** (สำคัญสุด) — เพิ่ม parent / ให้สิทธิ์ vet / เปลี่ยน permission / เพิ่ม-ลบสัตว์ จากหน้าเว็บ · ตอนนี้ยังต้องใส่ user_id มือใน Supabase → คนอื่นยังเข้าใช้จริงไม่ได้
- **แก้โปรไฟล์/การ์ด** — ชื่อเล่น/พันธุ์/วันเกิด/รูปโปรไฟล์/สถานะการ์ด (เฝ้าระวัง/ปกติ/ต้องดูแล) ยังแก้ผ่านเว็บไม่ได้
- **Step 7 cutover** — repo เป็น private · ปลด GitHub Token + password ออกจาก `admin.html` เดิม · ให้หน้าใหม่เป็น default
