...
| 5 · Inline edit ตามสิทธิ์ | ✅ ครบทุกหมวด 19 ก.ค. 2026 | เพิ่ม/แก้/ลบได้ทุกแท็บ: อาการประจำวัน(+รูป) · การรักษา(+รูป+flowchart) · ยา · นัดหมาย · ผลเลือด(+เพิ่มค่า/หมวดใหม่) · แท็บสรุป (สัญญาณอันตราย+ปฐมพยาบาลเลือดกำเดา · สิ่งที่ต้องติดตาม · ก้อนในตับ) · **แถม: ⚙️ ปรับหน้าสรุป** — parent เลือกซ่อน/แสดง/จัดลำดับ section ต่อตัวได้ (display.hidden/order) · ดีไซน์ read-only เป็น default กด ✏️ ค่อยจัดการ · **เหลือ:** หน้าจัดการครอบครัว |
